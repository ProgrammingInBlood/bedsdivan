...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* <div className="Mobilenavbar" style={{display:"flex"}}>
         <a href="#" className="menu-bars" >
         <h2 onClick={showSidebar}>open</h2>
          </a> 
         <nav className={sidebar ? 'nav-menu active': 'nav-menu'}>
             <ul className='nav-menu-items' onClick={showSidebar}>
                 <li className='navbar-toggle' style={{display:"flex"}}>
                     <a href="#" className='menu-bars'>
                           <h2>close</h2>
                     </a>

                 </li>
                 <div className="nav-text" style={{display:"flex"}}>
                     <ul>
                         <li>Home</li>
                         <li>DivanBeds</li>
                         <li>All Products</li>
              ...
              <div className="col-md-12 align-self-center">
                <div className="main-menu manu-color-white">
                  <ul>
                    ...
                    <li className="dropdown position-static">
                      <a href="/newproduct"> Living Room Furniture </a>
                      {/* <i
                                            className="ion-ios-arrow-down"></i> */}
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
            ...
            <div className="row">
              ...
              {/* <div className="col-md-12 text-center mb-8" data-aos="fade-up" data-aos-delay="200">
                    <ul className="product-tab-nav nav justify-content-center">
                                    <li className="nav-item"><a className="nav-link active" data-bs-toggle="tab" href="#tab-product-new-arrivals"><Image width={46} height={18}  alt="BedsDivan" src="/assets/images/icons/bed.png" /> Divan  Beds</a></li>
                                    <li className="nav-item"><a className="nav-link" data-bs-toggle="tab" href="#tab-product-best-sellers"><Image width={128} height={128}  alt="BedsDivan" src="/assets/images/icons/mattress.png" />Mattressess
                                 </a></li>
                                    <li className="nav-item"><a className="nav-link" data-bs-toggle="tab" href="#tab-product-sale-item"><Image width={128} height={128}  alt="BedsDivan" src="/assets/images/icons/divan.png" />Sleigh Beds
                                </a></li>
                                    <li className="nav-item"><a className="nav-link" data-bs-toggle="tab" href="#tab-product-on-sales"><Image width={128} height={128}  alt="BedsDivan" src="/assets/images/icons/couch.png" />Sofa</a></li>
                    </ul>
                </div> */}
            </div>
